    ...
    <div ref={ref} className="h-[200vh] relative ">
      <div className="sticky  h-screen flex justify-center items-center top-0">
        <div>
          ...
          >
            <h1 className="font-extrabold text-9xl md:text-[16rem] text-transparent bg-clip-text bg-gradient-to-r from-[#6600ff] via-[#9647cd] to-[hsl(194,100%,51%)] ">
              24
            </h1>
            <span className="text-6xl font-medium">Years</span>
            {/* <Lottie
              style={{ width: "300px" }}
              lottieRef={lottieRef}
              onDOMLoaded={() =>
...
function Word({ children, arrayLength, index, smoothScrollForWord }) {
  ...
  return <motion.span className="text-transparent bg-clip-text gradient-gray" style={{ opacity }}>{children}</motion.span>;
}
