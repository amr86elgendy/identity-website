  ...
  return (
    ...
    >
      ...
      <div className="text-center flex flex-col items-center z-10 ">
        ...
        {/* </div> */}
        <h1 className="mb-4 md:mb-6 capitalize">
          we&apos;re identity <br /> marketing agency
        </h1>
        <p className="mb-8 max-w-[50ch] px-4 sm:px-0">
          We build brands. from brand identity, to web development, social media
          campaigns & everything in between.
        </p>
